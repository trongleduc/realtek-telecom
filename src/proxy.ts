...
const demoNotice = `<!doctype html><html lang="vi"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Realtek Telecom</title></head>
...
<h1 style="font-size:24px;margin:12px 0">Trang quản trị chưa được bật</h1>
<p style="opacity:.75;max-width:460px">Website đang ở bản trình diễn giao diện. Trang quản trị sẽ hoạt động khi hệ thống được kết nối cơ sở dữ liệu.</p>
...
export default function proxy(request: NextRequest) {
  ...
  // The CMS is switched off (src/cms/README.md): /admin and /api get a notice instead of a 404.
  if (/^\/(admin|api)(\/|$)/.test(request.nextUrl.pathname)) {
